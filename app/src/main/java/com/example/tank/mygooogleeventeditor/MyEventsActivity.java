...
public class MyEventsActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
...
//                                    "Google Play Services on your device and relaunch this app.");
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<Event>> {
        ...
        private boolean isCreatedByUser(String creator, String owner) {
            return creator.equalsIgnoreCase(mCredential.getSelectedAccountName())
                    || owner.equalsIgnoreCase(mCredential.getSelectedAccountName())
                     ? true : false;
        }
